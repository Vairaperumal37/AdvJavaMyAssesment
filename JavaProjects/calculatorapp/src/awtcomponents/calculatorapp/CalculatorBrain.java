...
import awtcomponents.calculatorapp.models.CalculatorDigitClickListener;
import awtcomponents.calculatorapp.models.CalculatorOperatorClickListner;
import awtcomponents.calculatorapp.models.CalculatoSpecialOperatorClickListner;
import awtcomponents.calculatorapp.models.DisplayChangeListener;

public class CalculatorBrain implements CalculatorDigitClickListener, CalculatorOperatorClickListner,CalculatoSpecialOperatorClickListner {
	...
	@Override
	public void specialoperatorClicked(String sOperator) {

		if(sOperator.contentEquals("<-"))
		{
			String value = getValue();
			if (value.length() == 1)
			{
